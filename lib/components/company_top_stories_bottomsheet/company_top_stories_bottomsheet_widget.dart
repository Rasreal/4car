...
import 'company_top_stories_bottomsheet_model.dart';
export 'company_top_stories_bottomsheet_model.dart';
...
class _CompanyTopStoriesBottomsheetWidgetState
  ...
  late CompanyTopStoriesBottomsheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyTopStoriesBottomsheetModel());
