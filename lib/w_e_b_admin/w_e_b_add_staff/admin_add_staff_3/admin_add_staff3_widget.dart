...
import 'admin_add_staff3_model.dart';
export 'admin_add_staff3_model.dart';
...
class _AdminAddStaff3WidgetState extends State<AdminAddStaff3Widget> {
  late AdminAddStaff3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAddStaff3Model());

    _model.fioController ??=
        TextEditingController(text: FFAppState().adminAddStaffFIO);
    ...
    _model.password1Controller ??=
        TextEditingController(text: widget.password1);
    ...
    return StreamBuilder<List<CompaniesRecord>>(
      stream: queryCompaniesRecord(
        queryBuilder: (companiesRecord) => companiesRecord
            .where('company_users', arrayContains: currentUserReference),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<CompaniesRecord> adminAddStaff3CompaniesRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final adminAddStaff3CompaniesRecord =
            adminAddStaff3CompaniesRecordList.isNotEmpty
                ? adminAddStaff3CompaniesRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                                                              ...
                                                              child: Align(
                                                                ...
                                                                child: Material(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration:
                                                                        BoxDecoration(
                                                                      color: FFAppState().adminAddStaff ==
                                                                              'Менеджер'
                                                                          ? FlutterFlowTheme.of(context)
                                                                              .primaryColor
                                                                          : FlutterFlowTheme.of(context)
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.newUser =
                                          await actions.createUserNewFucn(
                                        widget.email!,
                                        widget.password!,
                                      );
