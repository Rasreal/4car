...
class _AdminAddCompany1WidgetState extends State<AdminAddCompany1Widget> {
  ...
  void initState() {
    ...
    _model.gisFocusNode ??= FocusNode();

    _model.yandexController ??= TextEditingController();
    _model.yandexFocusNode ??= FocusNode();
    ...
    _model.countBoxFocusNode ??= FocusNode();
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        FlutterFlowPlacePicker(
                                                          ...
                                                          webGoogleMapsApiKey:
                                                              'AIzaSyAec2zvbFkPz90kZbXAvNXzjY46ZIJv97Q',
                                                          onSelect:
                                                              (place) async {
                                                            setState(() => _model
                                                                    .placePickerValue =
                                            ...
                                            child:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return FFButtonWidget(
                                                  onPressed: () async {
                                                    if ((_model.gisController
                                                                    .text !=
                                                                null &&
                                                            _model.gisController
                                                                    .text !=
                                                                '') ||
                                                        (_model.yandexController
                                                                    .text !=
                                                                null &&
                                                            _model.yandexController
                                                                    .text !=
                                                                '') ||
                                                        (_model.googleController
                                                                    .text !=
                                                                null &&
                                                            _model.googleController
                                                                    .text !=
                                                      ...
                                                      await showDialog(
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Заполните поля для ссылки на адресс'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
