                  ...
                  builder: (context, snapshot) {
                    ...
                    return Wrap(
                      ...
                      children: List.generate(wrapForcarTimesRecordList.length,
                        ...
                        return StreamBuilder<List<WorkedDayBoxRecord>>(
                          stream: queryWorkedDayBoxRecord(
                            parent: widget.company?.reference,
                            queryBuilder: (workedDayBoxRecord) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            final containerWorkedDayBoxRecord =
                                containerWorkedDayBoxRecordList.isNotEmpty
                                    ? containerWorkedDayBoxRecordList.first
                                    : null;
                            return Container(
                              decoration: BoxDecoration(),
                              child: Column(
                                ...
                                children: [
                                  if ((functions.comparisonTime(
                                      ...
                                      valueOrDefault<bool>(
                                        containerWorkedDayBoxRecord != null,
                                        false,
                                      ))
                                    Padding(
