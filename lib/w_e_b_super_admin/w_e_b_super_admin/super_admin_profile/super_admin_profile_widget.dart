...
import 'super_admin_profile_model.dart';
export 'super_admin_profile_model.dart';

class SuperAdminProfileWidget extends StatefulWidget {
  const SuperAdminProfileWidget({Key? key}) : super(key: key);

  @override
  _SuperAdminProfileWidgetState createState() =>
      _SuperAdminProfileWidgetState();
}

class _SuperAdminProfileWidgetState extends State<SuperAdminProfileWidget> {
  late SuperAdminProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuperAdminProfileModel());
