                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        if (main1BookingsRecord.createdByUser)
                          Padding(
                        ...
                        if (main1BookingsRecord.createdByAdmin)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 32.0),
                            child: Row(
                                                                    ...
                                                                    bookingsRecord
                                                                        ...
                                                                        .where(
                                                                          ...
                                                                          isEqualTo: main1BookingsRecord.bookedDateString != ''
                                                                              ? main1BookingsRecord.bookedDateString
                                                                              : null,
                                                                        )
                                                                        .where(
                                                                          'booked_company',
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                            ...
                                                                            } else if (FFAppState().selectedTimeSlot == wrapForcarTimesRecord.reference) {
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  valueOrDefault<String>(
                                    '${valueOrDefault<String>(
                                      main1BookingsRecord.totalPrice.toString(),
                                      '0',
                                    )} тг',
                                    '0',
                                  ),
                              ...
                              if (main1BookingsRecord.boxName == null ||
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.dropDownAdminValueController ??=
