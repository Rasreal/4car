...
import '/components/w_e_b_filter_company_status_widget.dart';
import '/components/w_e_b_filter_select_city_widget.dart';
...
class SuperAdminMainWidget extends StatefulWidget {
  ...
  @override
  _SuperAdminMainWidgetState createState() => _SuperAdminMainWidgetState();
}
                                        ...
                                        Padding(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<CompaniesRecord>
                                                  containerModerationCompaniesRecordList =
                                                  snapshot.data!;
                                              return Container(
                                                width: 392.0,
                                                height: 168.0,
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          if (containerModerationCompaniesRecordList
                                                                  .length !=
                                                              0)
                                                            InkWell(
                                                              splashColor: Colors
                                        ...
                                        Padding(
                                          ...
                                          child: FutureBuilder<int>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              int containerCancelBookingCount =
                                                  snapshot.data!;
                                              return Container(
                                                width: 392.0,
                                                height: 168.0,
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Записи отмененные пользователями \nприложения.',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Акции которые хотят продвинуть в топ.',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                                            ...
                                            children: [
                                              ...
                                              StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<BookingsRecord>
                                                      containerCancelBookingBookingsRecordList =
                                                      snapshot.data!;
                                                  return Container(
                                                    width: 392.0,
                                                    height: 98.0,
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      functions
                                                                          .oborot(
                                                                              containerCancelBookingBookingsRecordList.toList())
                                                                          .toString(),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        functions
                                                                            .oborotName(containerCancelBookingBookingsRecordList.toList()),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      future:
                                                                        ...
                                                                        queryBuilder: (bookingsRecord) => bookingsRecord
                                                                            .where(
                                                                              'booked_company',
                                                                              isEqualTo: columnCompaniesRecord.reference,
                                                                            )
                                                                            .where(
                                                                              'status',
                                                                              isEqualTo: 'Закончено',
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            color:
                                                                                () {
                                                                              if (columnCompaniesRecord.status == 'Активно') {
                                                                                return FlutterFlowTheme.of(context).green;
                                                                              } else if (columnCompaniesRecord.status == 'Неактивна') {
