...
import 'admin_add_staff1_model.dart';
export 'admin_add_staff1_model.dart';

class AdminAddStaff1Widget extends StatefulWidget {
  const AdminAddStaff1Widget({
    Key? key,
...
class _AdminAddStaff1WidgetState extends State<AdminAddStaff1Widget> {
  late AdminAddStaff1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAddStaff1Model());
                                  ...
                                  FFButtonWidget(
                                      ...
                                      if (FFAppState().addStuffuserRef !=
                                        ...
                                        context.pushNamed(
                                          ...
                                          queryParams: {
                                            ...
                                            'stuffRef': serializeParam(
                                              FFAppState().addStuffuserRef,
                                    ...
                                    options: FFButtonOptions(
                                      ...
                                      iconPadding:
                                          EdgeInsetsDirectional.fromSTEB(
                                              0.0, 0.0, 0.0, 0.0),
                                      color: FFAppState().addStuffuserRef !=
                                              null
