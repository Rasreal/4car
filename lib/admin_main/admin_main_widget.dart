  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.role, '') == 'Супер Админ') {
        context.goNamedAuth('super_admin_main', context.mounted);
      }
      if (valueOrDefault(currentUserDocument?.adminStatus, '') ==
          'Не активен') {
        GoRouter.of(context).prepareAuthEvent();
        await authManager.signOut();
        GoRouter.of(context).clearRedirectLocation();

        context.goNamedAuth('admin_user_not_active', context.mounted);
      }
    });
                                                              ...
                                                              children: [
                                                                ...
                                                                StreamBuilder<
                                                                    List<
                                                                        WorkedDayBoxRecord>>(
                                                                  stream:
                                                                      queryWorkedDayBoxRecord(
                                                                    parent: rowCompaniesRecord
                                                                        ?.reference,
                                                                    queryBuilder:
                                                                        (workedDayBoxRecord) =>
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    List<WorkedDayBoxRecord>
                                                                        ...
                                                                        snapshot
                                                                            .data!;
                                                                    final containerWorkedDayBoxRecord = containerWorkedDayBoxRecordList
                                                                            .isNotEmpty
                                                                        ? containerWorkedDayBoxRecordList
                                                                            .first
                                                                        : null;
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Form(
                                                                                  ...
                                                                                  child: Visibility(
                                                                                    visible: containerWorkedDayBoxRecord != null,
                                                                                    child: Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 16.0, 0.0),
                                                                                      child: FlutterFlowDropDown<String>(
                                                                                        controller: _model.dropDownExistValueController ??= FormFieldController<String>(
                                                                                          _model.dropDownExistValue ??= containerWorkedDayBoxRecord?.countBoxName,
                                                                                        ),
                                                                                        options: functions.generateIntListString(rowCompaniesRecord!.countBox),
                                                                                        onChanged: (val) => setState(() => _model.dropDownExistValue = val),
                                                                                        width: 128.0,
                                                                                        height: 40.0,
                                                                                ...
                                                                                Form(
                                                                                  ...
                                                                                  child: Visibility(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 16.0, 0.0),
                                                                                      child: FlutterFlowDropDown<String>(
                                                                                        controller: _model.dropDownNotValueController ??= FormFieldController<String>(
                                                                                          _model.dropDownNotValue ??= valueOrDefault<String>(
                                                                                            rowCompaniesRecord?.countBox?.toString(),
                                                                                            '0',
                                                                                          ),
                                                                                        ),
                                                                                        options: functions.generateIntListString(rowCompaniesRecord!.countBox),
                                                                                        onChanged: (val) => setState(() => _model.dropDownNotValue = val),
                                                                                        width: 128.0,
                                                                                        height: 40.0,
                                                                                        textStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                ...
                                                                                FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    if (containerWorkedDayBoxRecord != null) {
                                                                                      if (_model.formKey2.currentState == null || !_model.formKey2.currentState!.validate()) {
                                                                                        return;
                                                                                      }
                                                                                      if (_model.dropDownExistValue == null) {
                                                                                        return;
                                                                                      }

                                                                                      await containerWorkedDayBoxRecord!.reference.update(createWorkedDayBoxRecordData(
                                                                                        countBoxName: _model.dropDownExistValue,
                                                                                        count: valueOrDefault<int>(
                                                                                          functions.stringToInt2(_model.dropDownNotValue!),
                                                                                          0,
                                                                                        ),
                                                                                      ));
                                                                                    } else {
                                                                                      ...
                                                                                      if (_model.dropDownNotValue == null) {
                                                                                        return;
                                                                                      }

                                                                                      await WorkedDayBoxRecord.createDoc(rowCompaniesRecord!.reference).set(createWorkedDayBoxRecordData(
                                                                                        countBoxName: _model.dropDownNotValue,
                                                                                        dateDMY: dateTimeFormat(
                                                                                          'd/M/y',
                                                                                          getCurrentTimestamp,
