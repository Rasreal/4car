...
class SuperAdminCurrentCompanyWidget extends StatefulWidget {
  const SuperAdminCurrentCompanyWidget({Key? key}) : super(key: key);
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          16),
                                                              child: Text(
                                                                'Бесплатный вайфай, Чай, кофе, Удобный сервис, Бонусная система',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyText1
                                                                    .override(
                                          ...
                                          children: [
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(0, 23, 0, 0),
                                              child: Text(
                                                'Операции с 01.08.2022 по 30.08.2022 23:51',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText1
                                                        .override(
